...
func TestGenerateCaddyfile(t *testing.T) {
	...
	if !strings.Contains(content, "siteone.com {") || !strings.Contains(content, "http://siteone.com.") || !strings.Contains(content, ".sslip.io {") {
	...
	if !strings.Contains(content, "sitetwo.net {") || !strings.Contains(content, "http://sitetwo.net.") || !strings.Contains(content, ".sslip.io {") {
